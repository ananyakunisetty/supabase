...
/**
 * Unified count formatter — handles compact display for row counts,
 * filter badge counts, and estimated totals.
 * Uses log-based unit selection for consistent K/M/B/T formatting.
 */
...
export function formatCompactNumber(value: number) {
  return formatCountDisplay(value)
}
